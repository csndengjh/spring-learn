...
public class FileEncryptAndDecrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filename = "D:/data/12121.jpg";

        String flag = readFileLastByte(filename, 6);
        if (flag.indexOf("hello") > 0) {
            // 加密过了;
        } else {
            // 没有加密
            FileEncryptAndDecrypt.encrypt(filename, "hello");
        }
        System.out.println(FileEncryptAndDecrypt.decrypt(
                filename,  filename, 6));
